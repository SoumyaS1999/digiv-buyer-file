        ...
        <section className="services services__2 py__130">
            <div className="container position-relative">
                ...
                <div className="services__wapper services__2_wapper">
                    <div className="row">
                        {servicesTwoData.slice(0, 3).map(({ description, id, imgSrc, title, link }) => (
                            <SlideUp
                                key={id}
                                className="col-xl-4 col-md-6 mb-5 mb-xl-0"
                                delay={id}
                            >
                                <ServiceCard description={description} title={title} link={link} imgSrc={imgSrc} className={id === 2 ? 'two' : id === 3 ? 'three' : ''} />
                            </SlideUp>
                        ))}
                    </div>
